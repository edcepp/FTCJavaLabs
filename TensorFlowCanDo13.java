...
//
// The is a low effiency proof of concept. It has a long way to go.
// The latest experiment focused confidence levels.
// TBD: Current question is the impact of camera model. Currently using a Logitech C270.
// What is the impact of a C930e.
//
...
@Autonomous(name="A TensorFlow CanDo challenge v13", group="Challenge")
//@Disabled

// --------------------------- TensorFlowCanDo13 class -----------------------------
// ------------------------------------------------------------------------------
public  class TensorFlowCanDo13 extends LinearOpMode
{
    //int MAX_HITS              =   2;
    double TARGET_STOP_COLOR  = 150;   // Greenish card
    //double HUE_TOLERANCE      =   5;   // degrees
    double TARGET_POWER       = 0.35;  // percent max
    double SLOW_POWER         = 0.25;  // Found cube slow
